...
Data from several sources were joined together into a merged dataset. We used 2017 year to build the model. Main outcome is suicide rate for each state, candidate predictors are gun, alchohol, temperature, precipitation, marijuana, education, gdp, gender for each state. 
...
We used stepwise regression to choice the predictors. As the results shows, "gun", "marijuana","education","gender","gdp" are significant predictors for suicide rate. 
