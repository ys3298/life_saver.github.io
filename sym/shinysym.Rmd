...
The Crude Suicide Rate map allows users to toggle between different years (1999-2017) and choose gender, demonstrating the changes in the suicide rate over time and visualize regional differences across the U.S. The map demonstrates that there are significant changes by gender over time. 

The line plot on the right shows the change of total suicide rate by year in US. We can see a stable increase by year.

**Suicide Rate**: The number of suicide deaths cases per 100k population.
...
renderPlotly({ 
  ...
  layout(geo = geo,
         title = "The U.S. Map - State Statistics")
})
```
...
The **The U.S. map** allows users to choose the types of variables, visualizing regional differences across the U.S.  
